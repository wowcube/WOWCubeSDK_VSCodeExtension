    ...
    static compareWDK(v1, v2) {
        try {
            ...
            if ((/(?<maj>\d{1,2})\.(?<min>\d{1,2})(\.(?<build>\d{1,4}))?/.test(v1)) &&
                ...
                var v2r = /(?<maj>\d{1,2})\.(?<min>\d{1,2})(\.(?<build>\d{1,4}))?/.exec(v2);
                ...
                if (typeof (maj1s) === 'undefined')
                    maj1s = '0';
                if (typeof (min1s) === 'undefined')
                    min1s = '0';
                if (typeof (build1s) === 'undefined')
                    build1s = '0';
                if (typeof (maj2s) === 'undefined')
                    maj2s = '0';
                if (typeof (min2s) === 'undefined')
                    min2s = '0';
                if (typeof (build2s) === 'undefined')
                    build2s = '0';
