...
class Configuration {
    ...
    static getLoggingMode() {
        var lm = Configuration.getString('wowsdk.conf.loggingmode');
        if (lm == "")
            lm = '1';
        return lm;
    }
    static setLoggingMode(value) {
        Configuration.setString('wowsdk.conf.loggingmode', value);
    }
