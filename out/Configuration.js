...
class Configuration {
    ...
    static getLoggingMode() { var lm = Configuration.getString('wowsdk.conf.loggingmode'); if (lm == "")
        lm = '1'; return lm; }
    static setLoggingMode(value) { Configuration.setString('wowsdk.conf.loggingmode', value); }
    ...
    static getCurrentVersion() {
        ...
        if (versionFound === false) {
            ...
            if (Configuration._detectedSDKVersions.length > 0)
                v = Configuration._detectedSDKVersions[Configuration._detectedSDKVersions.length - 1];
