...
class ExamplePanel {
    ...
    generateExampleRust(key, path) {
        var ret = { path: '', desc: '' };
        var fullpath = '';
        var needDeleteFolder = false;
        try {
            var ex = Providers_1.Providers.examples.examples_rust.e;
            ...
            var info = Configuration_1.Configuration.getWOWSDKPath() + "/sdk/examples/" + this._version + '/rust/' + this._key;
            var minfo = info;
            ...
            const templatespath = Configuration_1.Configuration.getWOWSDKPath() + 'sdk/templates/' + Configuration_1.Configuration.getCurrentVersion() + '/rust/';
            const iconFilename = templatespath + "icon.png";
            fs.copyFileSync(iconFilename, fullpath + '/assets/icon.png');
            //copy project files
            var sourcePrj = Configuration_1.Configuration.getWOWSDKPath() + "/sdk/examples/" + this._version + '/rust/' + this._key + "/project/src/";
            ...
            //copy resources
            var sourceImg = Configuration_1.Configuration.getWOWSDKPath() + "/sdk/examples/" + this._version + '/rust/' + this._key + "/project/assets/images/";
            var sourceSnd = Configuration_1.Configuration.getWOWSDKPath() + "/sdk/examples/" + this._version + '/rust/' + this._key + "/project/assets/sounds/";
            ...
            //copy build json
            fs.copyFileSync(Configuration_1.Configuration.getWOWSDKPath() + "/sdk/examples/" + this._version + '/rust/' + this._key + "/project/wowcubeapp-build.json", fullpath + '/wowcubeapp-build.json');
            //copy empty Cargo file
            fs.copyFileSync(Configuration_1.Configuration.getWOWSDKPath() + "/sdk/examples/" + this._version + '/rust/' + this._key + "/project/Cargo.toml", fullpath + '/Cargo.toml');
    ...
    _getHtmlForWebview(webview) {
        ...
        switch (this._language) {
            ...
            case 'cpp':
                ...
                break;
            case 'rust':
                ex = Providers_1.Providers.examples.examples_rust.e;
                break;
        }
        var availableVersions = ex.get(this._key);
        var currVersion = Configuration_1.Configuration.getCurrentVersion();
